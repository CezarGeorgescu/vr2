...
const Navbar = (props) => {
  ...
  return (
    <Fragment>
      <div className={"wrapper__side-nav-mobile bg__black d-flex d-lg-none " + (toogleMenu ? "active" : "")}>
        <div className="d-flex flex-wrap w-100">
          <div className="w-100">
            <div className="d-flex align-items-center justify-content-between mb-4">
              ...
              <svg onClick={() => setToogleMenu(!toogleMenu)} className="pointer" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M16.192 6.34399L11.949 10.586L7.70697 6.34399L6.29297 7.75799L10.535 12L6.29297 16.242L7.70697 17.656L11.949 13.414L16.192 17.656L17.606 16.242L13.364 12L17.606 7.75799L16.192 6.34399Z" fill="white" />
              </svg>

            </div>
            <div className="menu">
              <NavLink to="/" className="light font__size--14 text__14-1024 color__white">Home</NavLink>
              <hr />
              <NavLink to="/about" className="light font__size--14 text__14-1024 color__white">About</NavLink>
              <hr />
              <NavLink
                to="/service" className="light font__size--14 text__14-1024 color__white">Service</NavLink>
              <hr />
              <div className="position-relative">
                ...
                <div class="dropdown-menu wrapper__dropdown-menu-all font__size--14 text__14-1024" aria-labelledby="dropdownMenuButton">
                  <NavLink
                    to="/service/detail" class="dropdown-item">Detail Service</NavLink>
                  <NavLink
                    to="/pricing" class="dropdown-item">Pricing</NavLink>
                  <NavLink
                    to="/team" class="dropdown-item">Team</NavLink>
                  <NavLink
                    to="/faq" class="dropdown-item">FAQ</NavLink>
                  <NavLink
                    to="/terms" class="dropdown-item">Terms</NavLink>
                  <NavLink
                    to="/policy" class="dropdown-item">Privacy</NavLink>
                  <NavLink
                    to="/error" class="dropdown-item">404</NavLink>
                </div>
              </div>
              <hr />
              <div className="position-relative">
                ...
                <div class="dropdown-menu wrapper__dropdown-menu-all font__size--14 text__14-1024" aria-labelledby="dropdownMenuButton">
                  <NavLink
                    to="/blog" class="dropdown-item">Blog</NavLink>
                  <NavLink
                    to="/blog/detail" class="dropdown-item">Blog Detail</NavLink>
                </div>
              </div>
              <hr />
              <NavLink to="/contact" className="light font__size--16 text__16-1024 btn__action color__white pointer">Contact us</NavLink>
            </div>
          </div>
        </div>
      </div >
      ...
      >
        <div className="container position-relative">
          ...
          >
            <ul className="navbar-nav menu__center">
              ...
              <li className="nav-item position-relative">
                ...
                <div class="dropdown-menu wrapper__dropdown-menu-all" aria-labelledby="dropdownMenuButton">
                  <NavLink
                    to="/service/detail" class="dropdown-item">Detail Service</NavLink>
                  <NavLink
                    to="/pricing" class="dropdown-item">Pricing</NavLink>
          ...
          <NavLink to="/contact" className="d-none d-lg-block light font__size--16 text__16-1024 btn__action color__white  ml-auto pointer">Contact us</NavLink>
        </div>
      </nav>
    </Fragment >
  );
