                ...
                <div className="position-relative mb-5">
                    <div className="row">
                        <div className="col-md-5 z-2">
                            <p className="medium font__size--16 text-uppercase text__gr-default">OUR SERVICE</p>
                            <h2 className="semi-bold font__size--48">Our Service</h2>
                        </div>
                        <div className="col-md-7 z-2">
                            <p className="light font__size--16 color__gray-1 mb-3">We use the latest VR hardware and software to create high-quality VR experiences that are accessible and affordable. Our goal is to provide exceptional customer service and support, and our team is always available to answer any questions and address any concerns you may have.</p>
                        </div>
                    </div>
                    <img src="./../images/Ellipse 34.png" className="images__bg-sec-service" alt="" />
                </div>

                <div className="row">
                    {
                        service.map((obj, i) => {
                            return <div className={"col-md-6 col-lg-4 mb-4 " + (i == 1 ? "mt__grid-1" : i == 2 ? "mt__grid-2" : i == 3 ? "mt__grid-min-2" : i == 4 ? "mt__grid-min-1" : "")}>
                                <div className="wrapper__card-service">
                                    <img src={obj.icon} alt="" />
                                    <div className="w-100">
                                        <h5 className="normal font__size--20">{obj.title}</h5>
                                        <p className="mb-0 normal font__size--14 color__gray-1">{obj.desc}</p>
                                    </div>

                                    <div className="button">
                                        <div className="bold font__size--16 text__16-1024 btn__action color__white pointer">LEARN MORE</div>
                                    </div>
                                </div>
                            </div>
                        })
